			...
			{createdId ?
				...
				<>
					...
					<div onSubmit={(e) => { e.preventDefault() }} formNoValidate className='form-form'>
						<div className="form-switch form-switch--center poll-created-description">Use this QR Code to <Link to={`/poll/${createdId}`} className='form-switch-action'>Acces Poll</Link></div>
						...
						<div className="form-item form-item--clipboard">
							...
							<div
								...
								Or, <a href={`${window.location.protocol}//${window.location.host}/poll/${createdId}`} onClick={e => e.preventDefault()} className='form-switch-action'>share to other Apps</a></div>
						</div>
